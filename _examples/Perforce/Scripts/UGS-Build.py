...
workspace_name = f'{ci.Perforce.get_ci_client_prefix()}UGS-Build'
workspace_root = f'C:\\workspaces\\{workspace_name}'
client_view = [
    '//UE5/Main/... //$NAME/...',
    '-//UE5/Main/Engine/Plugins/... //$NAME/Engine/Plugins/...',
    '-//UE5/Main/Engine/Content/... //$NAME/Engine/Content/...',
    '-//UE5/Main/*Game/... //$NAME/*Game/...',
    '-//UE5/Main/Samples/... //$NAME/Samples/...'
]
...
ue.uat().exec_buildgraph(
    'Engine/Source/Programs/UnrealGameSync/BuildUGS.xml',
    'Publish Live Zip',
    [
        '-set:SubmitToStream=//InternalTools/UnrealGameSync',
        '-buildmachine',
        '-p4'
    ]
)
