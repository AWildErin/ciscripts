...
# Map sections used by unreal configurations
# Map configs get added in DefaultEditor.ini
map_section_configurations = {
    "Test": [
        "Maps_Dev"
    ]
}
...
# build_config - string
# steam_branch - string
steam_build_description_format = 'CL {p4_changelist}, Config {build_config}, Steam Branch: {steam_branch}'
